...
int TopkAgeRanges(hashtable* hashtable,char* str1,char* str2,int numEntries,char* virus,char* country,int top){
    int i,j,size,count=0;
    int in = 0;
...
void PatientAdmissionsCountry(hashtable* hashtable,char* str1,char* str2,int numEntries,char* virus,char* country,int totaljobs,char* jobsArray[totaljobs]){
    int i,j,size,count=0;
...
void PatientDischarges(hashtable* hashtable,char* str1,char* str2,int numEntries,char* virus,char* country,int totaljobs,char* jobsArray[totaljobs]){
    int i,j,size,count=0;
